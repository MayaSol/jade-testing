...
/***/ (function(module, exports) {
	...
	function makeRange(rangeId) {
		var slider = document.querySelector(rangeId);
		var button = slider.querySelector(rangeId + ' .range__button');
		...
		slider.onclick = function (evt) {
			var dotStart = slider.querySelector('.dots-range__item--start');
			var shiftX = dotStart.offsetLeft;
...
/***/ (function(module, exports) {
	...
	function makeLines(blockId) {
		var aboutText = document.querySelector(blockId);
		var fields = aboutText.querySelector('.about-text__fields');
		var newLine = aboutText.querySelector('#about-text-field-template').content;
	
		function nextLine(line, value) {
			if (value.length === line.maxLength) {
				var next = line.tabIndex + 1;
				if (next < fields.children.length) {
					fields.children[next].focus();
				} else {
					var newLineItem = newLine.cloneNode(true);
